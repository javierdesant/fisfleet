...
@Component
@Slf4j
public class VistaControladoraPartidaExt extends VistaControladoraPartida {

    public VistaControladoraPartidaExt() {
        super(new Scanner(""));
    }
}
//
...
//
//    @Autowired
//    public VistaControladoraPartidaExt(Consumer<Partida> partidaConsumer) {
//        super(null);
